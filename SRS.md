# Camera Observation Tool (COT) - Software Requirements Specification
...
![Image of Use Case Diagram](https://github.com/mymanu/Camera-Observation-Tool-Documentation/blob/main/Use_Case_Diagram.png)
